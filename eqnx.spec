...
1) install the source RPM:
	rpm -i eqnx-4.11-1.src.rpm		(wherever RPM is located)
...
3) install binary RPM:
	rpm -i <rpm directory>/RPMS/<ARCH>/eqnx-4.11-1.<ARCH>.rpm
...
%changelog
* Thu Jun 06 2006 Mike Straub (michael.straub@avocent.com)
